...
//
//*****************************************************************************
#define LISTBOX_STYLE_OUTLINE    0x0001
...
//
//*****************************************************************************
#define LISTBOX_STYLE_LOCKED     0x0002
...
//
//*****************************************************************************
#define LISTBOX_STYLE_WRAP       0x0004
...
//
//*****************************************************************************
extern int ListBoxMsgProc(tWidget *pWidget, unsigned ulMsg,
...
extern void ListBoxInit(tListBoxWidget *pWidget, const tDisplay *pDisplay,
                        ...
                        unsigned short usPopulatedEntries, unsigned lX, unsigned lY,
