...
extern "C"
{
   ...
   typedef struct
   {
      ...
      //
      void (*pfnPixelDraw)(void *pvDisplayData, unsigned lX, unsigned lY,
                           unsigned ulValue);
      
      //
      //! A pointer to the function to draw multiple pixels on this display.
      //
      void (*pfnPixelDrawMultiple)(void *pvDisplayData, unsigned lX, unsigned lY,
                                   unsigned lX0, unsigned lCount, unsigned lBPP,
      ...
      //
      void (*pfnLineDrawH)(void *pvDisplayData, unsigned lX1, unsigned lX2, unsigned lY,
                           unsigned ulValue);
      
      //
      //! A pointer to the function to draw a vertical line on this display.
      //
      void (*pfnLineDrawV)(void *pvDisplayData, unsigned lX, unsigned lY1, unsigned lY2,
                           unsigned ulValue);
      ...
      //
      unsigned (*pfnColorTranslate)(void *pvDisplayData,
...
#define GrRectContainsPoint(pRect, lX, lY)                                  \
   ...
   extern void GrCircleDraw(const tContext *pContext, unsigned lX, unsigned lY,
                            unsigned lRadius);
   extern void GrCircleFill(const tContext *pContext, unsigned lX, unsigned lY,
                            unsigned lRadius);
   ...
   extern void GrImageDraw(const tContext *pContext,
                           const unsigned char *pucImage, unsigned lX, unsigned lY);
   extern void GrLineDraw(const tContext *pContext, unsigned lX1, unsigned lY1, unsigned lX2,
                          unsigned lY2);
   extern void GrLineDrawH(const tContext *pContext, unsigned lX1, unsigned lX2, unsigned lY);
   extern void GrLineDrawV(const tContext *pContext, unsigned lX, unsigned lY1, unsigned lY2);
   extern void GrOffScreen1BPPInit(tDisplay *pDisplay, unsigned char *pucImage,
                                   long lWidth, long lHeight);

	extern void GrOffScreen4BPPInit(tDisplay *pDisplay, unsigned char *pucImage, long lWidth,
                    long lHeight);

	extern void GrOffScreen4BPPPaletteSet(tDisplay *pDisplay, unsigned long *pulPalette,
   ...
   extern void GrStringDraw(const tContext *pContext, const char *pcString,
                            int lLength, unsigned lX, unsigned lY,
                            int bOpaque);
   extern int GrStringWidthGet(const tContext *pContext, const char *pcString,
                                int lLength);
   extern void GrStringTableSet(const void *pvTable);
   int GrStringLanguageSet(unsigned short usLangID);
   unsigned GrStringGet(int iIndex, char *pcData, unsigned uSize);
