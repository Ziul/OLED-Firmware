...
typedef struct
{
    ...
    //! changed.
    //
    void (*pfnOnChange)(tWidget *pWidget, int bSelected);
}
tRadioButtonWidget;
...
//
//*****************************************************************************
extern int RadioButtonMsgProc(tWidget *pWidget, unsigned ulMsg,
                               unsigned ulParam1, unsigned ulParam2);
extern void RadioButtonInit(tRadioButtonWidget *pWidget,
                            const tDisplay *pDisplay, unsigned lX, unsigned lY,
