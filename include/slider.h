...
typedef struct
{
    ...
    //! changes.
    //
    void (*pfnOnChange)(tWidget *pWidget, unsigned lValue);
...
//
//*****************************************************************************
#define SL_STYLE_OUTLINE            0x0001
...
//
//*****************************************************************************
#define SL_STYLE_BACKG_FILL         0x0004
...
//
//*****************************************************************************
#define SL_STYLE_BACKG_TEXT         0x0010
...
//
//*****************************************************************************
#define SL_STYLE_BACKG_IMG          0x0040
...
//
//*****************************************************************************
#define SL_STYLE_TEXT_OPAQUE        0x0080
...
//
//*****************************************************************************
#define SL_STYLE_BACKG_TEXT_OPAQUE  0x0100
...
//
//*****************************************************************************
#define SL_STYLE_VERTICAL           0x0200
...
//
//*****************************************************************************
extern int SliderMsgProc(tWidget *pWidget, unsigned ulMsg,
                          unsigned ulParam1, unsigned ulParam2);
extern void SliderInit(tSliderWidget *pWidget,
                       const tDisplay *pDisplay, unsigned lX, unsigned lY, unsigned lWidth,
                       unsigned lHeight);
