...
//*****************************************************************************
static void
GrOffScreen1BPPPixelDraw(void *pvDisplayData, unsigned lX, unsigned lY,
...
//*****************************************************************************
static void
GrOffScreen1BPPPixelDrawMultiple(void *pvDisplayData, unsigned lX, unsigned lY,
                                 unsigned lX0, unsigned lCount, long lBPP,
                         ...
                         unsigned long ulValue)
{
    ...
    //
    if(((unsigned )pucData & 1) && ((lX2 - lX1) > 6))
    {
        //
    ...
    //
    if(((unsigned )pucData & 2) && ((lX2 - lX1) > 14))
    {
        //
                        ...
                        unsigned long ulValue)
{
    ...
    //
    if(((unsigned )pucData & 1) && ((pRect->sXMax - lX) > 6))
    {
        //
    ...
    //
    if(((unsigned )pucData & 2) && ((pRect->sXMax - lX) > 14))
    {
        //
