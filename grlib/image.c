...
//*****************************************************************************
void
GrImageDraw(const tContext *pContext, const unsigned char *pucImage, unsigned lX,
            unsigned lY)
{
    unsigned ulByte, ulBits, ulMatch, ulSize, ulIdx, ulCount, ulNum;
    unsigned lBPP, lWidth, lHeight, lX0, lX1, lX2;
