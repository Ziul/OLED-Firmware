...
//*****************************************************************************
static int
SliderValueToPosition(tSliderWidget *pSlider, unsigned lValue)
{
...
//*****************************************************************************
static int
SliderPositionToValue(tSliderWidget *pSlider, int sPos)
{
    int sMax;
    int sMin;
    unsigned lValue;
...
//*****************************************************************************
static int
SliderClick(tWidget *pWidget, unsigned ulMsg, unsigned lX, unsigned lY)
{
    tSliderWidget *pSlider;
...
//*****************************************************************************
int
SliderMsgProc(tWidget *pWidget, unsigned ulMsg,
...
//*****************************************************************************
void
SliderInit(tSliderWidget *pWidget, const tDisplay *pDisplay, unsigned lX, unsigned lY,
           unsigned lWidth, unsigned lHeight)
{
    unsigned ulIdx;
    ...
    //
    for(ulIdx = 0; ulIdx < sizeof(tSliderWidget); ulIdx += 2)
    {
