...
//*****************************************************************************
static int 
RectangularButtonClick(tWidget *pWidget, unsigned ulMsg, unsigned lX, unsigned lY)
{
    tPushButtonWidget *pPush;
...
//*****************************************************************************
int
RectangularButtonMsgProc(tWidget *pWidget, unsigned ulMsg,
...
RectangularButtonInit(tPushButtonWidget *pWidget, const tDisplay *pDisplay,
                      unsigned lX, unsigned lY, unsigned lWidth, unsigned lHeight)
{
    unsigned ulIdx;
    ...
    //
    for(ulIdx = 0; ulIdx < sizeof(tPushButtonWidget); ulIdx += 2)
    {
...
//*****************************************************************************
static int
CircularButtonClick(tWidget *pWidget, unsigned ulMsg, unsigned lX, unsigned lY)
{
    tPushButtonWidget *pPush;
    unsigned lXc, lYc, lR;
...
//*****************************************************************************
int
CircularButtonMsgProc(tWidget *pWidget, unsigned ulMsg,
                      unsigned ulParam1, unsigned ulParam2)
{
    //
    // Determine which message is being sent.
...
CircularButtonInit(tPushButtonWidget *pWidget, const tDisplay *pDisplay,
                   unsigned lX, unsigned lY, unsigned lR)
{
    unsigned ulIdx;
