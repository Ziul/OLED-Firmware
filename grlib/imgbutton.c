...
//*****************************************************************************
static int
ImageButtonClick(tWidget *pWidget, unsigned ulMsg, unsigned lX, unsigned lY)
{
    tImageButtonWidget *pPush;
...
//*****************************************************************************
int 
ImageButtonMsgProc(tWidget *pWidget, unsigned ulMsg,
                ...
                unsigned lX, unsigned lY, unsigned lWidth, unsigned lHeight)
{
    ...
    //
    for(ulIdx = 0; ulIdx < sizeof(tImageButtonWidget); ulIdx += 2)
    {
