...
//*****************************************************************************
static int 
RadioButtonClick(tWidget *pWidget, unsigned ulMsg, unsigned lX, unsigned lY)
{
...
//*****************************************************************************
int
RadioButtonMsgProc(tWidget *pWidget, unsigned ulMsg,
...
//*****************************************************************************
void
RadioButtonInit(tRadioButtonWidget *pWidget, const tDisplay *pDisplay, unsigned lX,
                unsigned lY, unsigned lWidth, unsigned lHeight)
{
    ...
    //
    for(ulIdx = 0; ulIdx < sizeof(tRadioButtonWidget); ulIdx += 2)
    {
