...
//*****************************************************************************
void
GrLineDrawH(const tContext *pContext, unsigned lX1, unsigned lX2, unsigned lY)
{
    unsigned lTemp;
...
//*****************************************************************************
void
GrLineDrawV(const tContext *pContext, unsigned lX, unsigned lY1, unsigned lY2)
{
    unsigned lTemp;
...
//*****************************************************************************
static int 
GrClipCodeGet(const tContext *pContext, unsigned lX, unsigned lY)
{
    int lCode;
...
//*****************************************************************************
static int  
GrLineClip(const tContext *pContext, unsigned *plX1, unsigned *plY1, unsigned *plX2,
           unsigned *plY2)
{
    int lCode, lCode1, lCode2;
    unsigned lX, lY;
...
//*****************************************************************************
void
GrLineDraw(const tContext *pContext, unsigned lX1, unsigned lY1, unsigned lX2, unsigned lY2)
{
