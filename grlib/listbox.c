...
//*****************************************************************************
static int 
ListBoxPointer(tListBoxWidget *pListBox, unsigned ulMsg, unsigned lX, unsigned lY)
{
    ...
    switch(ulMsg)
    {
        ...
        case WIDGET_MSG_PTR_UP:
        {
                ...
                GrRectContainsPoint(&(pListBox->sBase.sPosition), lX, lY))
            {
                ...
                //
                lLineNum = (lY - (unsigned)pListBox->sBase.sPosition.sYMin) /
                ...
                //
                lEntry = ((unsigned)pListBox->usStartEntry + lLineNum) %
                ...
                // clear the selection.
                //
                if((lEntry >= (unsigned)pListBox->usPopulated) ||
                   (lEntry == (unsigned)pListBox->sSelected))
                {
                    //
        ...
        case WIDGET_MSG_PTR_MOVE:
        {
            ...
            if(abs(lLineNum) >= GrFontHeightGet(pListBox->pFont))
            {
                ...
                //
                lScroll = lLineNum / (unsigned)GrFontHeightGet(pListBox->pFont);
                ...
                //
                lMaxUp = ((unsigned )pListBox->usPopulated - lVisible) + lMaxDown;
...
//*****************************************************************************
int
ListBoxMsgProc(tWidget *pWidget, unsigned ulMsg, unsigned ulParam1,
              unsigned ulParam2)
{
    tListBoxWidget *pListBox;
    ...
    switch(ulMsg)
    {
        ...
        case WIDGET_MSG_PTR_UP:
        case WIDGET_MSG_PTR_MOVE:
            return(ListBoxPointer(pListBox, ulMsg, ulParam1, ulParam2));
...
ListBoxInit(tListBoxWidget *pWidget, const tDisplay *pDisplay,
            ...
            unsigned short usPopulatedEntries, unsigned lX, unsigned lY, unsigned lWidth,
            unsigned lHeight)
{
    unsigned ulIdx;
