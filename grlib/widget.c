...
//
//*****************************************************************************
int g_ulMQOverflow = 0;
int g_ulMQNonMouseOverflow = 0;
int g_ulMQLastLostMsg = 0;
int g_ulMQMutexClash = 0;
int g_ulMQMoveOverwrite = 0;
#endif
...
//
//*****************************************************************************
static volatile int g_ulMQWrite = 0;
...
//*****************************************************************************
int
WidgetDefaultMsgProc(tWidget *pWidget, unsigned ulMessage,
...
//*****************************************************************************
int 
WidgetMessageSendPreOrder(tWidget *pWidget, unsigned ulMessage,
                          unsigned ulParam1, unsigned ulParam2,
                          int bStopOnSuccess)
{
    int ulRet;
...
//*****************************************************************************
int
WidgetMessageSendPostOrder(tWidget *pWidget, unsigned ulMessage,
                           unsigned ulParam1, unsigned ulParam2,
                           int bStopOnSuccess)
{
    int ulRet;
...
//*****************************************************************************
int
WidgetMessageQueueAdd(tWidget *pWidget, unsigned ulMessage,
                      unsigned ulParam1, unsigned ulParam2,
                      unsigned bPostOrder, int bStopOnSuccess)
{
    unsigned ulNext;
    int iOwned;
    ...
    //
    iOwned = WidgetMutexGet(&g_ucMQMutex);
    if(iOwned)
    {
        //
    ...
    if(ulMessage == WIDGET_MSG_PTR_MOVE)
    {
        ...
        if(g_ulMQRead != g_ulMQWrite)
        {
            ...
            //
            iOwned = (g_ulMQWrite == 0) ? (QUEUE_SIZE - 1) : (g_ulMQWrite - 1);
            ...
            if(g_pMQ[g_ulMQWrite].ulMessage == WIDGET_MSG_PTR_MOVE)
            {
                ...
                //
                g_pMQ[iOwned].ulParam1 = ulParam1;
                g_pMQ[iOwned].ulParam2 = ulParam2;
#ifdef DEBUG_MSGQ
                g_ulMQMoveOverwrite++;
#endif
...
//*****************************************************************************
int 
WidgetPointerMessage(unsigned ulMessage, unsigned lX, unsigned lY)
{
    //
