...
//*****************************************************************************
static void
CheckBoxPaint(tWidget *pWidget, unsigned bClick)
{
...
//*****************************************************************************
static unsigned 
CheckBoxClick(tWidget *pWidget, unsigned ulMsg, unsigned lX, unsigned lY)
{
    tCheckBoxWidget *pCheck;
...
//*****************************************************************************
int
CheckBoxMsgProc(tWidget *pWidget, unsigned ulMsg, unsigned ulParam1,
                unsigned ulParam2)
{
    //
...
//*****************************************************************************
void
CheckBoxInit(tCheckBoxWidget *pWidget, const tDisplay *pDisplay, unsigned lX,
             unsigned lY, unsigned lWidth, unsigned lHeight)
{
    unsigned ulIdx;
    ...
    //
    for(ulIdx = 0; ulIdx < sizeof(tCheckBoxWidget); ulIdx += 2)
    {
