...
//*****************************************************************************
int
ContainerMsgProc(tWidget *pWidget, unsigned ulMsg, unsigned ulParam1,
                 unsigned ulParam2)
{
    //
...
//*****************************************************************************
void
ContainerInit(tContainerWidget *pWidget, const tDisplay *pDisplay, unsigned lX,
              unsigned lY, unsigned lWidth, unsigned lHeight)
{
    ...
    //
    for(ulIdx = 0; ulIdx < sizeof(tContainerWidget); ulIdx += 2)
    {
